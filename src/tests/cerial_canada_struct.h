...
struct StringsStruct : public Cerial::RapidJsonObj<StringsStruct>
{
    StringsStruct() {
        static int ssInt = 0;
...
struct SingleStringObj : public Cerial::RapidJsonObj<SingleStringObj>
{
    SingleStringObj() {
        static int ssO = 0;
        _337100890 = "_337100890" + ssO;
        ssO++;
    }
...
struct TypesStruct : public Cerial::RapidJsonObj<TypesStruct>
{
    TypesStruct() {
        static int tsi = 1;
        static double tsd = 0.00001;
...
struct Event : public Cerial::RapidJsonObj<Event>
{
    Event(){
        static int ei = 1;
...
struct EventsCollection : public Cerial::RapidJsonObj<EventsCollection>
{
    Event _138586341;
    Event _138586345; 
    Event _138586349;
...
struct ObjectCollection : public Cerial::RapidJsonObj<ObjectCollection>
{
...
struct BigObj : public Cerial::RapidJsonObj<BigObj> {
...
struct BiggerObj : public Cerial::RapidJsonObj<BiggerObj> {

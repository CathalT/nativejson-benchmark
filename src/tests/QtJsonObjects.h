...
struct StringsStruct : public Cerial::QJsonObj<StringsStruct>
{
...
struct SingleStringObj : public Cerial::QJsonObj<SingleStringObj>
{
...
struct TypesStruct : public Cerial::QJsonObj<TypesStruct>
{
    TypesStruct() = default;
...
struct Event : public Cerial::QJsonObj<Event>
{
    Event() = default;
...
struct EventsCollection : public Cerial::QJsonObj<EventsCollection>
{
    Event _138586341;
    Event _138586345; 
    Event _138586349;
...
struct ObjectCollection : public Cerial::QJsonObj<ObjectCollection>
{
...
struct BigObj : public Cerial::QJsonObj<BigObj> {
    BigObj() = default;
    ObjectCollection _1;
    ObjectCollection _2;
    ObjectCollection _3;
...
struct BiggerObj : public Cerial::QJsonObj<BiggerObj> {
